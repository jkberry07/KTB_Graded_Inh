...
[mSpikeTrain, mVolt, gVolt, gSpikes, LFP_AMPA, LFP_NMDA, LFP_GABA, LFP_GABA_ton]...
...
fname_1 = sprintf('LFP50_VDSI1_mGABAlvl%g_%ggloms_inputlvl%g_tilvl%g_trial%g.mat',...
...
function [mI, gI, mIG,mIA,mIN,Xm,gIA,gIN, Xg, LFP_A, LFP_N, LFP_G, LFP_GGC] = current(mV, gV, Mg,...
        ...
        mIntegG = gIntegN .* BV; %In Osinski, GABA release followed NMDA current,
                                %so give the GABA current the same voltage
                                %dependence as the NMDA current
