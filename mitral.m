%This code is identical to that of the model by Kersen et al., found at https://github.com/dkersen/olfactory-bulb
...
classdef mitral %defines a mitral cell
    ...
    methods
        function m = assignProperties(m, gl, glomX, glomY, rmax, num)
            ...
            glom_distance = makedist('Logistic','mu', 78.3618, 'sigma', 23.0732); %Makes distribution
            glom_distance = truncate(glom_distance, 0, 300);     %of xy distances from glomerulus
